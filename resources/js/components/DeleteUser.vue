...
<template>
    <div class="space-y-6">
        ...
        <div
            class="space-y-4 rounded-lg border border-red-400 bg-red-200 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                    ...
                    <form class="space-y-6" @submit="deleteUser">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="password" type="password" name="password" ref="passwordInput"
                                v-model="form.password" placeholder="Password" class="bg-white" />
